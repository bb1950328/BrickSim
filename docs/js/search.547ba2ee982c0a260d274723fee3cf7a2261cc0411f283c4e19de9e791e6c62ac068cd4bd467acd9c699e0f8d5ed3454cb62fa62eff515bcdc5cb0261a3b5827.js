...
const idx = [
  ...
  {
    "link": "https://BrickSim.org/docs/technical_info/technologies_dependencies/",
  ...
  {
    "link": "https://BrickSim.org/docs/installation/windows/",
    "title": "Windows",
  ...
  {
    "link": "https://BrickSim.org/docs/technical_info/code_structure/",
  ...
  {
    "link": "https://BrickSim.org/docs/installation/linux/",
    "title": "Linux",
  ...
  {
    "link": "https://BrickSim.org/docs/features/static_analysis/",
  ...
  {
    "link": "https://BrickSim.org/docs/technical_info/",
    "title": "Technical Information",
    "body": "[Read this section if you are interested how BrickSim is made.]".toLowerCase(),
  },
  {
    "link": "https://BrickSim.org/docs/contributing/code/vscode_setup_windows/",
  ...
  {
    "link": "https://BrickSim.org/docs/contributing/web/",
    "title": "Website",
    "body": "[sdafasdasdf]".toLowerCase(),
  },
  {
    "link": "https://BrickSim.org/docs/contributing/code_of_conduct/",
  ...
  {
    "link": "https://BrickSim.org/docs/contributing/",
    "title": "Contributing",
  ...
  {
    "link": "https://BrickSim.org/docs/technical_info/documents/",
  ...
  {
    "link": "https://BrickSim.org/docs/installation/osx/",
    "title": "Mac OS X",
  ...
  {
    "link": "https://BrickSim.org/docs/contributing/code/vscode_setup_linux/",
    "title": "Using VS Code on Linux",
    "body": "[This tutorial was tested on Ubuntu 20.10, but it should work too on other versions or distributions. You'll have to install packages manually if you don't have apt. Do all steps from here Install VS Code via a way described in the offical VS Code docs Open VS Code and install the ms-vscode.cpptools and ms-vscode.cmake-tools extensions Press Ctrl + Shift+ P and type &quot;preferences: Open Settings (JSON)&quot; Hit Enter or click the first result and add the following text: 1 2 3 4 5 6 { &#34;cmake.buildDirectory&#34;: &#34;${workspaceFolder}/cmake-build&#34;, &#34;cmake.debugConfig&#34;: { &#34;cwd&#34;: &#34;${workspaceFolder}&#34; }, } Open the BrickSim folder in VS Code. You should get a notification like this one: Click &quot;Yes&quot; on that notification You will get a prompt looking like this: Select the one with /bin/gcc, the second last element on this screenshot The &quot;Play&quot; button in the bottom status bar doesn't choose the correct working directory as described in microsoft/vscode-cmake-tools#1395 You have to run it from the menu on the left side:]".toLowerCase(),
  },
  {
    "link": "https://BrickSim.org/docs/features/",
    "title": "Features",
    "body": "[This section gives you more information about the features of BrickSim.]".toLowerCase(),
  },
  {
    "link": "https://BrickSim.org/docs/installation/get_codes_txt/",
