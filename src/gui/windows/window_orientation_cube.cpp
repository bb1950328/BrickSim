            ...
            if (ImGui::ImageButton(gui_internal::convertTextureId(getImage()), ImVec2(displaySize, displaySize), ImVec2(0, 0), ImVec2(1, 1), 0)) {
                ...
                if (clickedSide.has_value()) {
                    switch (clickedSide.value()) {
                        case CubeSide::RIGHT:controller::setStandard3dView(3);
                            break;
                        case CubeSide::BOTTOM:controller::setStandard3dView(5);
                            break;
                        case CubeSide::BACK:controller::setStandard3dView(4);
                            break;
                        case CubeSide::LEFT:controller::setStandard3dView(6);
                            break;
                        case CubeSide::TOP:controller::setStandard3dView(2);
                            break;
                        case CubeSide::FRONT:controller::setStandard3dView(1);
                            break;
                    }
                }
            }
